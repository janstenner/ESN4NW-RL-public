...
off_policy_update_freq = 200
off_policy_batch_size = 256

antithetic_mean_samples = 3
...
function initialize_setup(;use_random_init = false)
    ...
    global env = GeneralEnv(do_step = do_step, 
        ...
        global agent = create_agent_flow_ppo(
...
optimal_trajectory = trajectories["FlowPPO"][rs_key]
