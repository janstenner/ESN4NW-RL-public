...
algorithms = [
    ("SAC", "ModelBased1/SAC/ModelBased1_SAC.jl"),
    ("SAC2", "ModelBased1/SAC2/ModelBased1_SAC2.jl"),
    ("PPO", "ModelBased1/PPO/ModelBased1_PPO.jl"),
    ("PPO3", "ModelBased1/PPO3/ModelBased1_PPO3.jl"),
    ("DDPG", "ModelBased1/DDPG/ModelBased1_DDPG.jl")
]
...
#     ("SAC2", "ModelBased1/SAC2/ModelBased1_SAC2.jl"),
#     ("PPO", "ModelBased1/PPO/ModelBased1_PPO.jl"),
#     ("PPO2", "ModelBased1/PPO2/ModelBased1_PPO2.jl"),
#     ("PPO3", "ModelBased1/PPO3/ModelBased1_PPO3.jl"),
#     ("DDPG", "ModelBased1/DDPG/ModelBased1_DDPG.jl")
# ]
...
function plot_validation_comparison(; current = false)
    ...
    include("ModelBased1/Validation_ModelBased1.jl")
