...
global set = [_normalize_validation_entry(e) for e in FileIO.load("./ModelBased1/validation_set.jld2","set")]
#FileIO.save("./ModelBased1/validation_set.jld2","set",set)


global validation_results = FileIO.load("./ModelBased1/validation_results.jld2","validation_results")
#FileIO.save("./ModelBased1/validation_results.jld2","validation_results",validation_results)
...
function regenerate_validation_grid_prices!(; same_day::Bool = false,
                                             save::Bool = true,
                                             set_path::AbstractString = "./ModelBased1/validation_set.jld2")
    global set
